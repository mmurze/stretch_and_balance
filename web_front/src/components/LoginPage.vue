        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-lg-auto">
                    ...
                    <li class="nav-item">
                        <router-link class="btn custom-btn bg-color" to="/register" href="#">
                            <a class="nav-link">Еще не зарегестрированы?</a>
                        </router-link>
                    </li>
                </ul>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="user-form" role="form" @submit.prevent="handleLogin()">
                    ...
                    <p>Вы должны ввести один символ, одну строчную и заглавную букву, как минимум. Длина не менее 8
                        символов</p>
                    <button class="form-controll" id="buttonSignIn">Войти</button>
